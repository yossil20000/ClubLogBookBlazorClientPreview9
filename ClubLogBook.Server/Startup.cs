...
namespace ClubLogBook.Server
{
    public class Startup
    {
		...
		public void ConfigureServices(IServiceCollection services)
        {
			...
			services.AddScoped<IRecordViewModelService<FlightRecordIndexModel>, FlightRecordViewModelService>();
			services.AddScoped<IRecordViewModelService<RecordsViewModel<FlightReservationModel>>, ReservationRecordViewModelService>();
